package com.Amokart.register.test;
...
import com.Amokart.generic.common.BaseClass_Register;
@Listeners(com.Amokart.generic.listenerutility.Listners.class)
public class RegisterFormData extends BaseClass_Register {
	...
	public void sendData() throws Throwable
	{
		...
		java.util.List<WebElement> radioButton = driver.findElements(
		...
		java.util.List<WebElement> option = counrty.getOptions();
